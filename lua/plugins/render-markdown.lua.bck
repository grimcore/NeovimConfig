return {
    ...
    init = function()
        -- green purple headings  1 - 6
        -- background
        local color1_bg = "#4E2A6E"
        local color2_bg = "#106656"
        local color3_bg = "#8A4D1E"
        local color4_bg = "#4E2A6E"
        local color5_bg = "#106656"
        local color6_bg = "#8A4D1E"

        -- foreground
        local color1_fg = "#E4D8FF"
        local color2_fg = "#B4FFEA"
        local color3_fg = "#FFEAD6"
        local color4_fg = "#E4D8FF"
        local color5_fg = "#B4FFEA"
        local color6_fg = "#FFEAD6"
